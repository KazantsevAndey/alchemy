...
- Когда говоришь про ДРР или расходы на рекламу — используй ТОЛЬКО поля summary.yesterday.drr_pct, summary.yesterday.drr_total, summary.month.drr_pct, summary.month.drr_total. ЗАПРЕЩЕНО делить expenses.items.«Оплата за клик» (или любой другой пункт расходов) на выручку и называть результат ДРР: это даст ЛОЖНЫЙ процент, потому что знаменатель и числитель из разных систем учёта.
...
# ══════════════════════════════════════════════════════════════════════════
    ...
    if not ymy.get("gross"):
        st.caption("За вчера Маркет ещё не сформировал отчёт: лист «Размещение» появляется "
                   "ближе к 11:00 МСК, ночное обновление его не застаёт. Нажмите «Загрузить данные» днём.")
